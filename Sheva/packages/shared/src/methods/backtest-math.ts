import type { BacktestEntry } from "../types/methods";
import type { ProfitMetrics } from "../types/stats";

const round = (value: number) => Number(value.toFixed(4));

export const calculateBacktestMetrics = (entries: BacktestEntry[]): ProfitMetrics => {
