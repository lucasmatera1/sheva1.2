...
Arquitetura:
  1. Browser Chromium mantém sessão autenticada + validação GeoComply
...
async def setup_browser():
    """Configura browser Playwright Chromium com geo."""
    ...
    return pw, context, page, engine, placer


async def main() -> None:
    global STAKE

    pw, context, page, engine, placer = await setup_browser()
