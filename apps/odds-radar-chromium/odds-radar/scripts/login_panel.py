"""Painel para login no Bet365 via Camoufox.

O Bet365 bloqueia login com preenchimento automatizado. Este painel
abre o Camoufox para o usuário logar manualmente (mouse/teclado reais)
...
class LoginPanel:
    ...
    def _build_ui(self) -> None:
        ...
        tk.Label(
            ...
            text="O Bet365 bloqueia login automatizado.\n"
                 "Faça login manual dentro do Camoufox.",
        ...
        self.login_btn = tk.Button(
            btn_frame, text="🌐  Abrir Camoufox e Logar", font=("Segoe UI", 12, "bold"),
        ...
        instructions = tk.Label(
            self.root,
            text="1. Clique em 'Abrir Camoufox e Logar'\n"
    ...
    def _open_manual_login(self) -> None:
        ...
        self.status_label.config(text="⏳ Abrindo Camoufox...", fg="#f0c040")
