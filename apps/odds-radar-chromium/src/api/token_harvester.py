...
Mantém browser Chromium rodando para validação GeoComply,
...
Arquitetura:
  Browser (Chromium)  →  Token Harvester  →  HTTP Client (httpx)
...
class TokenHarvester:
    """Extrai e mantém tokens frescos de uma sessão Chromium ativa."""
